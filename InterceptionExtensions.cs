...
namespace ErrorUnit.Injector_SimpleInjector.InterceptionExtensions
{
    //Code Copied and modified from http://simpleinjector.readthedocs.org/en/latest/InterceptionExtensions.html
    ...
    public static class Interceptor
    {
        ...
        private sealed class InterceptorProxy : RealProxy
        {
            ...
            private static MethodBase ToStringMethod = typeof(object).GetMethod("ToString");
            ...
            private IMessage Bypass(IMethodCallMessage message, object value = null)
            {
                value = value ?? message.MethodBase.Invoke(this.realInstance, message.Args);
